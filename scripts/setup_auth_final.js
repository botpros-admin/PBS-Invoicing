...
// Use testemail.com domain for PBS staff to avoid any domain restrictions
const userConfigurations = {
  // PBS Staff Users (public.users table) - Using testemail.com domain
  pbsStaff: [
    {
  ...
  // Client Portal Users (public.client_users table) - Keep existing domains
  clientUsers: [
    {
...
async function setupAuthSystem() {
  ...
  console.log('Using testemail.com domain for PBS staff to avoid domain restrictions\n');
  ...
  const testCredentials = [
    { email: 'superadmin@testemail.com', password: 'SuperAdmin123!', type: 'Super Admin' },
    { email: 'admin@testemail.com', password: 'TempPass123!', type: 'PBS Admin' },
    { email: 'billing@testemail.com', password: 'TempPass123!', type: 'PBS Billing' },
    { email: 'claims@testemail.com', password: 'TempPass123!', type: 'PBS Claims' },
  ...
  console.log('\n✅ ALL USERS NOW USE WORKING EMAIL DOMAINS');
  console.log('\nYou can now login with the following credentials:\n');
  console.log('PBS Staff Users (using testemail.com):');
  console.log('  - superadmin@testemail.com / SuperAdmin123!');
  console.log('  - admin@testemail.com / TempPass123!');
  console.log('  - billing@testemail.com / TempPass123!');
  console.log('  - claims@testemail.com / TempPass123!');
  console.log('\nClient Portal Users:');
